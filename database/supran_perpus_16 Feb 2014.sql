...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2014 at 02:07 PM
...
CREATE TABLE IF NOT EXISTS `tbl_buku` (
  ...
  `prioritas_buku` enum('1','2','3') DEFAULT NULL,
...
INSERT INTO `tbl_buku` (`kode_buku`, `prioritas_buku`, `judul_buku`, `subjek`, `penulis`, `penerbit`, `tahun_terbit`, `jumlah_halaman`, `tempat_terbit`, `bahasa`, `panjang`, `lebar`, `ISBN`, `cetakan`, `keterangan`, `tgl_daftar_buku`) VALUES
('009-B-Matematika', NULL, 'Matematika SMP 1', 'Matematika,Bahasa Inggris', 'Retno Uhuy', 'Pabelan', 2008, 130, 'Jogjakarta', 'Indonesia', 12, 14, '08899', '2', '<p>Heloo</p>', NULL),
('e45_009', NULL, 'Fisika bikin pusing', 'Fisika', 'Yolanda', 'Press', 2000, 123, 'Sorong', 'Inggris', 12, 10, 'ffrttt', 'ke 2', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `tbl_siswa` (
  ...
  `agama` enum('Islam','Katholik','Protestan','Hindu','Budha','Lainnya') DEFAULT NULL,
  ...
  `jarak` enum('< 5 Km','5 Km - 10 Km','> 10 Km') DEFAULT NULL,
  `nama_ayah` varchar(255) DEFAULT NULL,
  `pekerjaan_ayah` enum('PNS','TNI/POLRI','Swasta','Tani','Wiraswasta','Nelayan','Lainnya') DEFAULT NULL,
  `nama_ibu` varchar(255) DEFAULT NULL,
  `pekerjaan_ibu` enum('Ibu Rumah Tangga','PNS','TNI/POLRI','Swasta','Tani','Wiraswasta','Nelayan','Lainnya') DEFAULT NULL,
  `penghasilan_ortu` enum('100.000-1.000.000','1.000.000-2.500.000','2.500.000-5.000.000','5.000.000-7.500.000','7.500.000-10.000.000','> 10.000.000') DEFAULT NULL,
  `kendaraan` enum('Roda-2','Roda-4','Lainnya') DEFAULT NULL,
  `foto` varchar(255) DEFAULT NULL,
  `keterangan` text,
  `password` varchar(255) DEFAULT NULL,
  `user` varchar(255) DEFAULT NULL,
  `tgl_daftar_siswa` timestamp NULL DEFAULT NULL,
  `tgl_ubah_siswa` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`nis`),
...
INSERT INTO `tbl_siswa` (`nis`, `nisn`, `nama_depan`, `nama_belakang`, `nama_panggilan`, `tempat_lahir`, `tanggal_lahir`, `gender`, `gol_darah`, `agama`, `suku`, `status_keluarga`, `saudara_ke`, `jumlah_saudara`, `warga_negara`, `alamat_rumah`, `kode_pos`, `telepon`, `no_hp`, `jarak`, `nama_ayah`, `pekerjaan_ayah`, `nama_ibu`, `pekerjaan_ibu`, `penghasilan_ortu`, `kendaraan`, `foto`, `keterangan`, `password`, `user`, `tgl_daftar_siswa`, `tgl_ubah_siswa`) VALUES
(12345, 1234512345, 'Nadine', 'Chandrawinata', 'Ndun', 'Sorong', '1985-06-11', 'Perempuan', 'B', 'Islam', 'Jawa Campur', 'Anak Kandung', 1, 5, 'WNI', 'Perumnas Kilo 10', '98417', '', '0852XXXXXXXX', '5 Km - 10 Km', 'Chandrawinata', 'PNS', 'Winarni', 'Ibu Rumah Tangga', '1.000.000-2.500.000', 'Roda-4', '', '', '', 'admin', '2014-01-09 12:48:54', '2014-02-15 00:50:42'),
(94725, 94725123, 'Jaka', 'Susena', 'Aka', 'Banjarnegara', '1995-01-03', 'Laki-laki', 'A', 'Islam', 'Sunda', 'Anak Kandung', 0, 6, 'WNI', 'Antapani', '24567', '022', '0852', '', 'Wijaya Karna', 'PNS', 'Wijayani', '', '', 'Roda-2', '', '', '', 'admin', '2014-01-09 12:49:48', '2014-01-09 04:04:03');
...
('as', '457391c9c82bfdcbb4947278c0401e41', 'Asa', NULL, '1', 'asa', '2014-02-10 10:39:11'),
