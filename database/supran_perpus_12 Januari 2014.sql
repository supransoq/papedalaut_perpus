...
--
-- Host: localhost
-- Generation Time: Jan 12, 2014 at 01:06 AM
...
INSERT INTO `tbl_siswa` (`nis`, `nisn`, `nama_depan`, `nama_belakang`, `nama_panggilan`, `tempat_lahir`, `tanggal_lahir`, `gender`, `gol_darah`, `agama`, `suku`, `status_keluarga`, `saudara_ke`, `jumlah_saudara`, `warga_negara`, `alamat_rumah`, `kode_pos`, `telepon`, `no_hp`, `jarak`, `nama_ayah`, `pekerjaan_ayah`, `penghasilan_ayah`, `nama_ibu`, `pekerjaan_ibu`, `penghasilan_ibu`, `kendaraan`, `foto`, `keterangan`, `password`, `user`, `tgl_daftar_siswa`, `tgl_ubah_siswa`) VALUES
(12345, 1234512345, 'Nadine', 'Chandrawinata', 'Ndun', 'Sorong', '1985-06-11', 'Perempuan', 'B', 'Islam', 'Jawa Campur', 'Anak Kandung', 1, 5, 'WNI', 'Perumnas Kilo 10', '98417', '', '0852XXXXXXXX', 'Kurang dari 5 Km', 'Chandrawinata', 'Penusaha Kaya', 20000000, 'Winarni', 'Ibu RT ', 12000000, 'Lainnya', '', '', '', 'admin', '2014-01-09 12:48:54', '2014-01-09 04:22:27'),
(94725, 94725123, 'Jaka', 'Susena', 'Aka', 'Banjarnegara', '1995-01-03', 'Laki-laki', 'A', 'Islam', 'Sunda', 'Anak Kandung', 0, 6, 'WNI', 'Antapani', '24567', '022', '0852', 'Antara 5 Km - 10 Km', 'Wijaya Karna', 'PNS', 20000000, 'Wijayani', 'IRT', 0, 'Roda-2', '', '', '', 'admin', '2014-01-09 12:49:48', '2014-01-09 04:04:03'),
(321321312, 0, '3213213121', '', '', 'Sorong', '2010-01-06', 'Laki-laki', '', '', '', '', 0, 0, '', 'Perumnas', '', '', '', '', 'BAPAK', 'Cariduit', 0, 'MAMA', '', 0, 'Lainnya', '', '', '', 'admin', '2014-01-09 12:48:30', '2014-01-09 03:48:30');
