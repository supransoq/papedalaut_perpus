...
<head>
	...
	<script type="text/javascript">
		...
		function tambah(){
			var target="<?php echo site_url() ?>/admin/csiswa/tambah"
			$("#search").hide();
			$("#body").load(target);
		}
		function browse(){
			var target="<?php echo site_url() ?>/admin/csiswa/browse/0/true/0"
		...
		function edit(param){
			var target="<?php echo site_url() ?>/admin/csiswa/edit";
			var xdata={ ID : param }
		...
		function hapus(param){
			var target="<?php echo site_url() ?>/admin/csiswa/hapus/0/true/2";
			var xdata={ nis : param }
		...
		function simpan_tambah(){
			var target="<?php echo site_url() ?>/admin/csiswa/simpan_tambah/0/true/3";
		...
		function simpan_edit(){
			var target="<?php echo site_url() ?>/admin/csiswa/simpan_edit/0/true/1";
		...
		function hapussemua(){
			var target="<?php echo site_url() ?>/admin/csiswa/hapussemua/0/true/2";
		...
		function cari(){
			var target="<?php echo site_url() ?>/admin/csiswa/browse/0/true/4";
		...
		function lihat(param){
			var target="<?php echo site_url() ?>/admin/csiswa/lihat"
			var xdata={ ID : param }
...
<div id="container">
			...
			<tr>
				...
				$("#key").change(function(){
					...
					if (selectValues == 'status_otentikasi'){
						$.ajax({
							url : "<?php echo site_url('admin/csiswa/pilihotentikasi')?>",
	...
	<div id="body">
		<?php $this->load->view("admin/siswa/browse_siswa_view"); ?>
	</div>
